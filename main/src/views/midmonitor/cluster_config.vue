<template>
  <div class="app-container">
    ...
    >
      <el-table-column type="expand" width="30px">
        <template slot-scope="scope">
            <el-table v-if="scope.row.cluster_type===1" :data="scope.row.instances" class="nestedtable" stripe highlight-current-row border size="mini" >
     ...
     <!-- @selection-change="handleSelectionChange" -->
      ...
      <el-table-column label="控制台脚本" show-overflow-tooltip min-width="120">
        <template slot-scope="scope">
          <span>{{ scope.row.console_script_path }}</span>
        </template>
      </el-table-column>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="集群名称" prop="cluster_name">
              <el-input v-model.trim="clusterInsert.cluster_name" type="text" auto-complete="off" style="width:127%"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="集群别名" prop="cluster_name_alias">
              <el-input v-model.trim="clusterInsert.cluster_name_alias" type="text" auto-complete="off" style="width:127%"/>
            </el-form-item>
          </el-col>
        </el-row>
         <el-row>
          <el-col :span="12">
            <el-form-item label="集群类型" prop="cluster_type">
              <el-select v-model.trim="clusterInsert.cluster_type" style="width:118%">
          ...
          <el-col :span="12">
            <el-form-item label="状态" prop="status">
              <el-select v-model.trim="clusterInsert.status" style="width:118%">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户名" prop="username">
              <el-input v-model.trim="clusterInsert.username" type="text" auto-complete="off" style="width:127%"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="密码" prop="password" >
              <el-input v-model.trim="clusterInsert.password" type="password" auto-complete="off" show-password style="width:255px;"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="控制台URL" prop="console_url">
              ...
              <el-input v-model.trim="clusterInsert.console_url" type="text" auto-complete="off" placeholder="IP:PORT" style="width:91%;">
                <template slot="prepend">http://</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="控制台脚本" prop="console_script_path">
              <el-input v-model.trim="clusterInsert.console_script_path" type="text" auto-complete="off" style="width:127%"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="联系人" prop="contacts">
              <el-select v-model="clusterInsert.contacts" multiple filterable clearable placeholder="请选择联系人" style="width:118%">
                <el-option v-for="(item,index) in users" :key="index" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="备注" prop="comments">
              <el-input v-model.trim="clusterInsert.comments" type="textarea" auto-complete="off" style="width:135%"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-dialog title="修改集群信息" :visible.sync="dialogVisible" width="880px" @close="handleCloseDialog" :close-on-click-modal="false">
      <el-form ref="editForm" :model="clusterEdit" :rules="rules" label-width="100px" :inline="true" style="width:100%;padding-left:0.4%;">
        <el-row>
          <el-col :span="12">
            <el-form-item label="集群名称" prop="cluster_name">
              <el-input v-model.trim="clusterEdit.cluster_name" type="text" auto-complete="off" style="width:107%"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="集群别名" prop="cluster_name_alias">
              <el-input v-model.trim="clusterEdit.cluster_name_alias" type="text" auto-complete="off" style="width:107%"/>
            </el-form-item>
          </el-col>
        </el-row>
         <el-row>
          <el-col :span="12">
            <el-form-item label="集群类型" prop="cluster_type">
              <el-select v-model.trim="clusterEdit.cluster_type" >
              <el-option v-for="(type,index) in types" :key="index" :label="type.label" :value="type.value" style="width:90%"/>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="状态" prop="status">
              <el-select v-model.trim="clusterEdit.status">
              <el-option v-for="(type,index) in status" :key="index" :label="type.label" :value="type.value" />
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户名" prop="username">
              <el-input v-model.trim="clusterEdit.username" type="text" auto-complete="off" style="width:107%"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="密码" prop="password">
              <el-input v-model.trim="clusterEdit.password" type="password" auto-complete="off" show-password/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="控制台URL" prop="console_url">
              <!-- <el-input v-model.trim="clusterInsert.console_url" type="text" auto-complete="off" placeholder="IP:PORT"/> -->
              <el-input v-model.trim="clusterEdit.console_url" type="text" auto-complete="off" placeholder="IP:PORT" style="width:78%;">
                <template slot="prepend">http://</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="控制台脚本" prop="console_script_path">
              <el-input v-model.trim="clusterEdit.console_script_path" type="text" auto-complete="off" style="width:107%"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="联系人" prop="contacts">
              <el-select v-model="clusterEdit.contacts" multiple filterable clearable placeholder="请选择联系人">
                <el-option v-for="(item,index) in users" :key="index" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="备注" prop="comments">
              <el-input v-model.trim="clusterEdit.comments" type="textarea" auto-complete="off" style="width:115%"/>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      types2: [{value: 'rocketmq', label: 'RocketMQ'}, { value: 'kafka', label: 'Kafka'}, { value: 'ES', label: 'ES'}],
...
//过滤相关
    ...
    getClustersInf() {
      ...
      getClusters(this.listQuery).then(response => {
