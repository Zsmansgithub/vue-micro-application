        ...
        <el-row>
          <el-col  :span="24" class="col-1400-16 col-1400-offset-2">
            <el-form-item label="配置信息">
              <label slot="label">
                <el-tooltip class="item" effect="dark" content="" placement="top-end">
                  <div slot="content">磁盘最大1000G</div>
                  <svg-icon class-name="help-svg" icon-class="help" style="width: 18px; height:18px"/>
                </el-tooltip>
                配置信息
              </label>
              <div>
                <el-table :data="newAppForm.configinfo">
                  ...
                  <el-table-column prop="newcpumem" label="新cpu / 新内存"  align="center">
                    <template slot-scope="scope">
                      <el-form-item :prop="'configinfo.' + scope.$index + '.newcpumem'" :rules="scope.row.newdisk == undefined?{required:true}:{required:false}">
                        <el-cascader expand-trigger="hover" :options="cpumemoptions" v-model="scope.row.newcpumem" style="width:100%;"></el-cascader>
                      </el-form-item>
                    </template>
                  </el-table-column>
                  <el-table-column prop="newdisk" label="新磁盘容量(扩容后容量)"  align="center">
                    <template slot-scope="scope">
                      <el-form-item :prop="'configinfo.' + scope.$index + '.newdisk'" :rules="scope.row.newcpumem == ''?{required:true}:{required:false}">
                        <!-- <el-select v-model="scope.row.newdisk" placeholder="请选择" style="width: 100%">
                          <el-option v-for="item in diskoptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select> -->
                        <el-input-number v-model.trim="scope.row.newdisk" controls-position="right" :min="0" :max="1000" :precision="0" :controls="false" style="width: 80%;"></el-input-number>
                        <span>G</span>
                      </el-form-item>
                    </template>
                  </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      // cpuoptions:[{ value:'2C', label:'2C' },{ value:'4C', label:'4C' },{ value:'6C', label:'6C' },{ value:'8C', label:'8C' },{ value:'10C', label:'10C' },
      // { value:'12C', label:'12C' },{ value:'16C', label:'16C' },],
      ...
      cpumemoptions:[
        ...
        {
          value:'6C', label:'6C',
          children:[{ value:'4G', label:'4G' },{ value:'6G', label:'6G' },{ value:'8G', label:'8G' },{ value:'12G', label:'12G' },{ value:'16G', label:'16G' }]
        },
        {
          value:'8C', label:'8C',
          children:[{ value:'4G', label:'4G' },{ value:'6G', label:'6G' },{ value:'8G', label:'8G' },{ value:'12G', label:'12G' },{ value:'16G', label:'16G' }]
        ...
        {
          value:'10C', label:'10C',
          children:[{ value:'4G', label:'4G' },{ value:'6G', label:'6G' },{ value:'8G', label:'8G' },{ value:'12G', label:'12G' },{ value:'16G', label:'16G' },{ value:'32G', label:'32G' }]
        },
        {
          value:'12C', label:'12C',
          children:[{ value:'4G', label:'4G' },{ value:'6G', label:'6G' },{ value:'8G', label:'8G' },{ value:'12G', label:'12G' },{ value:'16G', label:'16G' },{ value:'32G', label:'32G' }]
