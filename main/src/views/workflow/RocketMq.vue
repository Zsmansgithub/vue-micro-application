      ...
      <el-form ref="newAppForm" :model="newAppForm" :rules="rules" label-width="180px" class="newAppForm"
        ...
        <el-row>
          <el-col style="text-align: right" :span="24" class="col-1400-16 col-1400-offset-2">
            <el-form-item>
              <span v-if="isMQandDZ" style="color:red;">独占型MQ,应用的应用类型不是RocketMQ,不能提交<br /></span>
              <!-- <el-tooltip content="应用的应用类型不是MQ" placement="top" :disabled="!isMQandDZ"> -->
              <el-button v-if="this.$route.params.uuid == null" type="primary" @click="saveDraftsForm('newAppForm')" :disabled="isMQandDZ" :loading="buttondisabled">保存草稿</el-button>
              <el-button v-else type="primary" @click="submitEditForm('newAppForm',1)" :disabled="isMQandDZ" :loading="buttondisabled">保存草稿</el-button>
              <!-- </el-tooltip> -->
              <el-button @click="resetForm('newAppForm')">重置</el-button>
              <!-- <el-tooltip content="应用的应用类型不是MQ" placement="top" :disabled="!isMQandDZ"> -->
              <el-button v-if="this.$route.params.uuid == null" type="primary" @click="submitForm('newAppForm')" :disabled="isMQandDZ" :loading="buttondisabled">立即提交</el-button>
              <el-button v-else type="primary" @click="submitEditForm('newAppForm',0)" :disabled="isMQandDZ" :loading="buttondisabled">提交草稿</el-button>
              <!-- </el-tooltip> -->
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    // 独占型day+7 共享型day+3
    changeexpecteddate(){
      if ( this.newAppForm.type == '独占型' && this.newAppForm.app_type !== 'RocketMQ' && this.newAppForm.app_type !== 'RocketMq') {
        this.isMQandDZ = true
      } else{
        this.isMQandDZ = false
      }
