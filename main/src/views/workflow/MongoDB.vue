<template>
  <div class="app-container">
    ...
    <div>
      <el-form ref="newAppForm" :model="newAppForm" :rules="rules" label-width="170px" class="newAppForm"
               style="width:100%">
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12" class="col-1400-8">
            <el-form-item label="doc大小(单位:kb)" prop="doc">
              <el-input-number v-model.trim="newAppForm.doc" controls-position="right" :min="1" :precision="0" :controls="false" style="width:100%"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12" class="col-1400-8 col-1400-offset-2">
            <el-form-item label="doc字段(单位:个)" prop="docnum">
              <el-input-number v-model.trim="newAppForm.docnum" controls-position="right" :min="1" :precision="0" :controls="false" style="width:100%"></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="12" class="col-1400-8">
            <el-form-item label="每日写入数据(单位:G)" prop="daydate">
              <el-input-number v-model.trim="newAppForm.daydate" controls-position="right" :min="1" :max="2000" :precision="0" :controls="false" style="width:100%"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col style="text-align: right" :span="24" class="col-1400-16 col-1400-offset-2">
            <el-form-item>
              <span v-if="isMongoDBandDZ" style="color:red;">应用的应用类型不是MongoDB,不能提交<br /></span>
              <!-- <el-tooltip content="应用的应用类型不是MongoDB" placement="top" :disabled="!isMongoDBandDZ"> -->
              <el-button v-if="this.$route.params.uuid == null" type="primary" @click="saveDraftsForm('newAppForm')" :disabled="isMongoDBandDZ" :loading="buttondisabled">保存草稿</el-button>
              <el-button v-else type="primary" @click="submitEditForm('newAppForm',1)" :disabled="isMongoDBandDZ" :loading="buttondisabled">保存草稿</el-button>
              <!-- </el-tooltip> -->
              <el-button @click="resetForm('newAppForm')">重置</el-button>
              <!-- <el-tooltip content="应用的应用类型不是MongoDB" placement="top" :disabled="!isMongoDBandDZ"> -->
              <el-button v-if="this.$route.params.uuid == null" type="primary" @click="submitForm('newAppForm')" :disabled="isMongoDBandDZ" :loading="buttondisabled">立即提交</el-button>
              <el-button v-else type="primary" @click="submitEditForm('newAppForm',0)" :disabled="isMongoDBandDZ" :loading="buttondisabled">提交草稿</el-button>
              <!-- </el-tooltip> -->
            </el-form-item>
          </el-col>
        </el-row>
    ...
    data() {
      return {
        ...
        rules: {
          ...
          doc: [{required: true, message: '请输入doc大小', trigger: 'blur'},],
          docnum: [{required: true, message: '请输入doc字段', trigger: 'blur'},],
          daydate: [{required: true, message: '请输入每日写入数据', trigger: 'blur'},],
    ...
    methods: {
      ...
      renderDraftsData1() {
        try {
          ...
          this.newAppForm.doc = this.aDetail.doc
          this.newAppForm.docnum = this.aDetail.docnum
          this.newAppForm.daydate = this.aDetail.daydate
      ...
      projectChange(choose) {
        ...
        fetchAppInfo(this.newAppForm.app_id).then(response => {
          ...
          if ( this.newAppForm.app_type !== 'MongoDB') {
            this.isMongoDBandDZ = true
          } else{
            this.isMongoDBandDZ = false
          }
