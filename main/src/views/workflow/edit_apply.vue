  ...
  <div class="app-container">
    ...
    <div>
      <el-form ref="newAppForm" :model="newAppForm" :rules="rules" label-width="130px" class="newAppForm" style="width:100%">
        ...
        <el-row>
          <el-col :span="12" class="col-1400-8 col-1400-offset-2">
            <el-form-item label="变更原因" prop="edit_reason">
              <el-input v-model="newAppForm.edit_reason" type="textarea" maxlength="200" :autosize="{ minRows: 2, maxRows: 8}"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" class="col-1400-8">
            <el-form-item label="变更内容" prop="edit_event">
              <el-input v-model="newAppForm.edit_event" type="textarea" maxlength="200" :autosize="{ minRows: 2, maxRows: 8}"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12" class="col-1400-8 col-1400-offset-2">
            <el-form-item label="变更步骤" prop="edit_step">
              <el-input v-model="newAppForm.edit_step" type="textarea" maxlength="200" :autosize="{ minRows: 2, maxRows: 8}"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" class="col-1400-8">
            <el-form-item label="回退方案" prop="backplan">
              <el-input v-model="newAppForm.backplan" type="textarea" maxlength="200" :autosize="{ minRows: 2, maxRows: 8}"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12" class="col-1400-8 col-1400-offset-2">
            <el-form-item label="验证方案" prop="testplan">
              <el-input v-model="newAppForm.testplan" type="textarea" maxlength="200" :autosize="{ minRows: 2, maxRows: 8}"/>
            </el-form-item>
          </el-col>
          <el-col :span="12" class="col-1400-8">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      renderDraftsData1() {
        try {
          this.newAppForm.edit_event = this.aDetail.edit_event
          this.newAppForm.edit_reason = this.aDetail.edit_reason
          ...
          this.newAppForm.edit_step = this.aDetail.edit_step
          this.newAppForm.backplan = this.aDetail.backplan
          this.newAppForm.testplan = this.aDetail.testplan
